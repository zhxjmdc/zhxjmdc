        ...
        <div class="col-lg-12 animated fadeInRight">
            <div class="mail-box-header">
                <div class="pull-right tooltip-demo">
                    <button onclick="articleEdit('<?php echo ($article["arid"]); ?>')" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="发布"><i class="fa fa-pencil"></i>&nbsp;保存</button>
                    <a href="<?php echo U('Home/Article/article_drafts',array('arid' => $article['arid']));?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="存为草稿"><i class="fa fa-times"></i>&nbsp;存为草稿</a>
                </div>
            ...
            <div class="mail-box">
                <div class="mail-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="title" class="form-control" value="<?php echo ($article["title"]); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">描述：</label>
                            <div class="col-sm-10">
                                <input type="text" id="describe" class="form-control" value="<?php echo ($article["describe"]); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">作者：</label>
                            <div class="col-sm-10">
                                <input type="text" id="author" class="form-control" value="<?php echo ($article["author"]); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 input-group date article-add-date">
                                <select class="form-control" id="aid">
                                    <option value="<?php echo ($article["aid"]); ?>"><?php echo ($article["typename"]); ?></option>
                                    <?php if(is_array($grouptype)): foreach($grouptype as $key=>$v): ?><option value="<?php echo ($v["aid"]); ?>"><?php echo ($v["typename"]); ?></option><?php endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        <img class="ibox-content-img" onerror="this.src='/zhxjmdc/1/Admin/Template/Images/default_img.jpg'" src="<?php echo ($article["path"]); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        ...
        Dropzone.options.dropzone = {
            url: "<?php echo U('Home/Article/upload_img');?>",
            maxFiles: 1,
            maxFilesize: 3,
            addRemoveLinks: true,
            dictRemoveLinks: "x",
